...
public class Product6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productName.setText(getString(R.string.product6Name));
        productPrice.setText("$400");
        productDescription.setText(getString(R.string.product6Description));
        ...
        buyBtn.setOnClickListener(new View.OnClickListener() {
            @Override
                                      public void onClick(View v) {
                                          if (checkMoney(400) == true)
                                          {
                                              createProduct();
                                              createUserProduct();
                                              updateData(400);
                                              Toast.makeText(Product6Activity.this, "ซื้อสินค้าเรียบร้อย", Toast.LENGTH_SHORT).show();
                                              startActivity(new Intent(getApplicationContext(), Summary.class));
                                          }
                                          else{
                                              Toast.makeText(Product6Activity.this, "ไม่สามารถซื้อสินค้าได้ โปรดตรวจสอบยอดเงินอีกครั้ง", Toast.LENGTH_SHORT).show();
                                          }
                                      }
                                  }
    ...
    public void createProduct(){
        ...
        product.put("name", getString(R.string.product6Name));
        product.put("price", 400);
        product.put("detail", getString(R.string.product6Description));
    ...
    public void createUserProduct(){
        ...
        userProduct.put("productName", getString(R.string.product6Name));
        ...
        fStore.collection("users").whereEqualTo("money", myMoney).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful() && !task.getResult().isEmpty()){
                    ...
                    Toast.makeText(Product6Activity.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
