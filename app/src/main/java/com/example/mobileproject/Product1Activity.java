...
public class Product1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productName.setText(getString(R.string.product1Name));
    ...
    public void createProduct(){
        ...
        product.put("name", getString(R.string.product1Name));
        product.put("price", 10);
        product.put("detail", getString(R.string.product1Description));
//        product.put("picture",)
        ...
        fStore.collection("users").whereEqualTo("money", myMoney).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful() && !task.getResult().isEmpty()){
                    ...
                    Toast.makeText(Product1Activity.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
