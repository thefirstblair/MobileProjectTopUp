...
public class Product7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productName.setText(getString(R.string.product7Name));
        productPrice.setText("$300");
        productDescription.setText(getString(R.string.product7Description));
        imageView.setImageResource(R.drawable.womanface);
        ...
        buyBtn.setOnClickListener(new View.OnClickListener() {
                                      ...
                                      public void onClick(View v) {
                                          if (checkMoney(300) == true)
                                          {
                                              createProduct();
                                              createUserProduct();
                                              updateData(300);
                                              Toast.makeText(Product7Activity.this, "ซื้อสินค้าเรียบร้อย", Toast.LENGTH_SHORT).show();
                                              startActivity(new Intent(getApplicationContext(), Summary.class));
                                          }
                                          else{
                                              Toast.makeText(Product7Activity.this, "ไม่สามารถซื้อสินค้าได้ โปรดตรวจสอบยอดเงินอีกครั้ง", Toast.LENGTH_SHORT).show();
                                          }
                                      }
                                  }
    ...
    public void createProduct(){
        ...
        product.put("name", getString(R.string.product7Name));
        product.put("price", 300);
        product.put("detail", getString(R.string.product7Description));
    ...
    public void createUserProduct(){
        ...
        userProduct.put("productName", getString(R.string.product7Name));
        ...
        fStore.collection("users").whereEqualTo("money", myMoney).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful() && !task.getResult().isEmpty()){
                    ...
                    Toast.makeText(Product7Activity.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
